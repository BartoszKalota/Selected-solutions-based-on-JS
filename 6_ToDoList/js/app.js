function init() {
    ...
    function addNewTask(event) {
        ...
        if ( phrase.length <= 5 ^ phrase.length >= 100 ) {
            ...
            if ( 
                ...
                // Utworzenie następującego wpisu do listy (zadania):
                //     <li data-priority="2">
                //         <h3>Task 1</h3>
                //         <p>Priority: 2</p>
                ...
                newCompleteBtn.addEventListener('click', markAsComplete);
    ...
    function removeCompleteTasks(event) {
    ...
    removeFinishedTasksBtn.addEventListener('click', removeCompleteTasks);
